...
- [SwiftUI native inspector width persistence](references/swiftui-inspector-width.md) — inspector column width is scene-level; measure via .onGeometryChange (macOS 15+), restore via ideal, re-seed per workspace with .id
