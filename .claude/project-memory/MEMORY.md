...
- [SwiftUI owns the main menu](references/swiftui-mainmenu-miniaturize-resync.md) — menu bar is defined in `.commands` (SwiftUI resync would clobber any imperative NSApp.mainMenu); empty Format/Help stubs stripped in applicationWillUpdate
