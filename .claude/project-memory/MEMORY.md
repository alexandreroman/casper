...
- [Diff-view main-thread layout hang](references/diff-view-refresh-hang.md) — ~98% CPU spin, no crash report; explicit baseline guides are barred from the pinned file header; frame-count recipe to tell the three variants apart + falsified hypotheses
