...
- [Custom resizable inspector panel](references/swiftui-inspector-width.md) — Casper hand-rolls the inspector (native .inspector aborts on macOS 26 drag); custom HStack + divider tracking the pointer by absolute location
