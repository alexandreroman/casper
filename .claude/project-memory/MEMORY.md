...
- [App icon design and generation pipeline](references/app-icon.md) — full-bleed split-terminal mark (Ghostty caret + agent sparkle); icon.svg master → `make icon` (resvg+iconutil) → committed AppIcon.icns wired via CFBundleIconFile
